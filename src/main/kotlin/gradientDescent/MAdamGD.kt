...
class MAdamGD(modelInfo: ModelInfo, learningRate: Double = 0.003, derivativeCalculator: DerivativeCalculator, costCalculator: CostCalculator) : AbstractDynamicGD(modelInfo = modelInfo, learningRate, derivativeCalculator, costCalculator) {
